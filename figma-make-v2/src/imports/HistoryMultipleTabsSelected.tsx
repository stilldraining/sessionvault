import svgPaths from "./svg-03ne9kkfg4";
...
export default function HistoryMultipleTabsSelected() {
  return (
    <div className="bg-black content-stretch flex flex-col items-start relative size-full" data-name="History / Multiple tabs selected">
      <Container1 />
      <MainContent />
    </div>
  );
