import svgPaths from "./svg-ye2sh5x5h8";
...
export default function ActiveWindowSelected() {
  return (
    <div className="bg-black content-stretch flex flex-col items-start relative size-full" data-name="Active window selected">
      <Header />
      <MainContent />
    </div>
  );
