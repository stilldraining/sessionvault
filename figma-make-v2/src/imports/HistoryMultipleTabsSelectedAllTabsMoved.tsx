import svgPaths from "./svg-rvxbgq7s9g";
...
function Notification() {
  return (
    <div className="absolute bg-[#007f40] box-border content-stretch flex gap-[10px] items-center justify-center left-[calc(50%+0.5px)] pl-[11px] pr-[12px] py-[8px] rounded-[8px] top-[387px] translate-x-[-50%]" data-name="Notification">
      <div className="flex flex-col font-['Departure_Mono:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[14px] text-nowrap text-white">
        <p className="leading-[1.4] whitespace-pre">TABS MOVED TO ACTIVE WINDOW</p>
      </div>
    </div>
  );
}

export default function HistoryMultipleTabsSelectedAllTabsMoved() {
  return (
    <div className="bg-black content-stretch flex flex-col items-start relative size-full" data-name="History / Multiple tabs selected / All tabs moved">
      <Header />
      <MainContent />
      <Notification />
    </div>
