import svgPaths from "./svg-xxtz41rix4";
...
export default function HistoryTabsSaved() {
  return (
    <div className="bg-black content-stretch flex flex-col items-start relative size-full" data-name="History / Tabs saved">
      <Header />
      <MainContent />
    </div>
  );
