import svgPaths from "./svg-t87ige2x1i";
  ...
  return (
    <div className="basis-0 content-stretch flex grow items-center justify-between min-h-px min-w-px relative shrink-0" data-name="Text Container">
      <div className="flex flex-col font-['Departure_Mono:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-nowrap text-white">
        <p className="leading-[1.4] whitespace-pre">2 TAB SELECTED</p>
      </div>
      <ExternalLinkButton />
    </div>
  );
...
function SaveSheet() {
  return <div className="absolute bg-[rgba(255,255,255,0.19)] h-[467px] left-0 top-0 w-[600px]" data-name="Save sheet" />;
}

function CloseRemove() {
  return (
    <div className="absolute left-[8px] size-[18px] top-[8px]" data-name="Close remove">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
        <g id="Close remove">
...
function CloseIcon() {
  return (
    <div className="bg-zinc-900 relative rounded-[100px] shrink-0 size-[33px]" data-name="Close icon">
      <div aria-hidden="true" className="absolute border border-[#2c2c30] border-solid inset-0 pointer-events-none rounded-[100px]" />
      <CloseRemove />
    </div>
  );
...
function CloseButton() {
  return (
    <div className="content-stretch flex gap-[10px] items-center relative shrink-0" data-name="Close button">
      <CloseIcon />
    </div>
  );
}
...
function ArrowDown1() {
  return (
    <div className="overflow-clip relative shrink-0 size-[18px]" data-name="Arrow - Down 2">
...
function LocationSelector() {
  return (
    <div className="bg-[rgba(255,255,255,0.06)] relative rounded-[4px] shrink-0 w-full" data-name="Location selector">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
...
function TitleInput() {
  return (
    <div className="bg-[rgba(255,255,255,0.06)] relative rounded-[4px] shrink-0 w-full" data-name="Title input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex items-center justify-between p-[8px] relative w-full">
          <div className="flex flex-col font-['Departure_Mono:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-[rgba(255,255,255,0.5)] text-nowrap">
            <p className="leading-[1.4] whitespace-pre">Enter title</p>
          </div>
        </div>
      </div>
    </div>
...
function TagsInput() {
  return (
    <div className="bg-[rgba(255,255,255,0.06)] relative rounded-[4px] shrink-0 w-full" data-name="Tags input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex items-center justify-between p-[8px] relative w-full">
          <div className="flex flex-col font-['Departure_Mono:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-[rgba(255,255,255,0.5)] text-nowrap">
            <p className="leading-[1.4] whitespace-pre">Enter tags</p>
          </div>
        </div>
      </div>
    </div>
...
function SaveForm() {
  return (
    <div className="basis-0 grow min-h-px min-w-px relative shrink-0 w-full" data-name="Save form">
      <div className="size-full">
...
function SaveButton() {
  return (
    <div className="basis-0 bg-[#3232ff] grow min-h-px min-w-px relative rounded-[8px] shrink-0" data-name="Save button">
...
function SaveToNotion() {
  return (
    <div className="absolute bg-black content-stretch flex flex-col h-[467px] items-start justify-between left-[350px] overflow-clip top-0 w-[250px]" data-name="Save to Notion">
      <Container13 />
      <SaveForm />
      <Container14 />
    </div>
...
export default function HistorySaveSheet() {
  return (
    <div className="bg-black content-stretch flex flex-col items-start relative size-full" data-name="History / Save sheet">
      <Container1 />
      <MainContent />
      <SaveSheet />
      <SaveToNotion />
