import svgPaths from "./svg-f6jmifsfz0";
...
function ExternalLinkContainer() {
  return (
    <div className="bg-zinc-900 relative rounded-[100px] shrink-0 size-[33px]" data-name="External link container">
...
function Skull() {
  return (
    <div className="absolute left-[7px] size-[18px] top-[8px]" data-name="Skull">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
        <g id="Skull">
          <path clipRule="evenodd" d={svgPaths.p27c55b80} fill="var(--fill-0, white)" fillRule="evenodd" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function SkullIconContainer() {
  return (
    <div className="bg-[#ca0101] relative rounded-[100px] shrink-0 size-[33px]" data-name="Skull icon container">
...
function ExternalLinkIcon() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0" data-name="External link icon">
...
function King() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="King">
...
function Title2() {
  return (
    <div className="box-border content-stretch flex gap-[10px] items-center pb-[8px] pt-[12px] px-0 relative shrink-0 w-full" data-name="Title">
      <SectionTitle2 />
    </div>
  );
}
...
export default function HistorySessionOrganised() {
  return (
    <div className="bg-black content-stretch flex flex-col items-start relative size-full" data-name="History / Session organised">
      <Header />
      <MainContent />
    </div>
  );
