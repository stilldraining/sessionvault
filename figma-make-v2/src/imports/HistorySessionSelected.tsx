import svgPaths from "./svg-x7auikxt7d";
...
export default function HistorySessionSelected() {
  return (
    <div className="bg-black content-stretch flex flex-col items-start relative size-full" data-name="History session selected">
      <Header />
      <MainContent />
    </div>
  );
