import svgPaths from "../imports/svg-ye2sh5x5h8";
import { SessionItem } from "../App";
    ...
    >
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className={`box-border content-stretch flex gap-[10px] items-center p-[8px] relative w-full ${isSelected ? 'bg-[#121212]' : ''}`}>
          <div className="content-stretch flex flex-col font-['Departure_Mono:Regular',sans-serif] items-start justify-center leading-[0] not-italic relative shrink-0 text-nowrap text-left">
