...
import svgPaths from "../imports/svg-f6jmifsfz0";
import svgPathsGraveyard from "../imports/svg-zipai1vj0x";
...
function GraveyardSkull() {
  return (
    <div className="relative shrink-0 size-[24px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Skull">
          <path clipRule="evenodd" d={svgPathsGraveyard.p2fb32400} fill="var(--fill-0, white)" fillRule="evenodd" id="Vector" opacity="0.4" />
          <path clipRule="evenodd" d={svgPathsGraveyard.p288de080} fill="var(--fill-0, white)" fillRule="evenodd" id="Vector_2" />
          <path clipRule="evenodd" d={svgPathsGraveyard.p36674780} fill="var(--fill-0, white)" fillRule="evenodd" id="Vector_3" />
          <path clipRule="evenodd" d={svgPathsGraveyard.p17506580} fill="var(--fill-0, white)" fillRule="evenodd" id="Vector_4" />
          <path clipRule="evenodd" d={svgPathsGraveyard.p1ea15100} fill="var(--fill-0, white)" fillRule="evenodd" id="Vector_5" />
          <path clipRule="evenodd" d={svgPathsGraveyard.p3f128d00} fill="var(--fill-0, white)" fillRule="evenodd" id="Vector_6" />
          <path clipRule="evenodd" d={svgPathsGraveyard.p30a51700} fill="var(--fill-0, white)" fillRule="evenodd" id="Vector_7" />
        </g>
      </svg>
    </div>
  );
...
function TabCard({
  ...
  return (
    ...
    >
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex gap-[10px] items-center p-[8px] relative w-full">
          <div className="basis-0 content-stretch flex flex-col font-['Departure_Mono:Regular',sans-serif] grow items-start justify-center leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-left">
            <div className="flex flex-col justify-center min-w-full relative shrink-0 text-[14px] text-white w-[min-content]">
              <p className="leading-[1.4]">{tab.title}</p>
            </div>
...
export function TabList({ tabs, selectedTabIds, onTabSelect, onTabClick, onClearSelection, isGraveyardSession }: TabListProps) {
  const handleContainerClick = (e: React.MouseEvent) => {
    ...
    // TabCards will stopPropagation, so this only fires for empty space clicks
    onClearSelection();
  };
  ...
  if (tabs.length === 0) {
    return (
      <div 
        ...
        onClick={handleContainerClick}
      >
        <div className="flex flex-col font-['Departure_Mono:Regular',sans-serif] text-[12px] text-[rgba(255,255,255,0.5)]">
