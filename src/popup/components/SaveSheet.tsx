import svgPaths from "../imports/svg-savesheet";
...
export function SaveSheet({ isOpen, onClose, onSave }: SaveSheetProps) {
  ...
  return (
    <>
      {/* Backdrop */}
      <div
        className="absolute bg-[rgba(255,255,255,0.19)] h-[457px] left-0 top-0 w-[600px] z-10 animate-fadeIn"
        onClick={onClose}
      />

      {/* Save Panel */}
      <div
        className="absolute bg-black content-stretch flex flex-col h-[457px] items-start justify-between left-[350px] overflow-clip top-0 w-[250px] z-20 animate-slideIn"
      >
        {/* Header */}
          ...
          <div className="size-full">
            <div className="box-border content-stretch flex flex-col gap-[10px] items-start p-[16px] relative size-full">
              ...
              <button className="bg-[rgba(255,255,255,0.06)] relative rounded-[4px] shrink-0 w-full cursor-pointer hover:bg-[rgba(255,255,255,0.08)] transition-colors">
                <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
                  <div className="box-border content-stretch flex items-center justify-between p-[8px] relative w-full">
                    <div className="flex flex-col font-['Departure_Mono',monospace] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-[rgba(255,255,255,0.5)] text-nowrap">
              ...
              <input
                ...
                className="bg-[rgba(255,255,255,0.06)] relative rounded-[4px] shrink-0 w-full border-none outline-none font-['Departure_Mono',monospace] text-[12px] text-white placeholder:text-[rgba(255,255,255,0.5)] p-[8px] focus:bg-[rgba(255,255,255,0.08)] transition-colors"
              />
