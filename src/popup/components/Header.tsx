import svgPaths from "../imports/svg-header";
...
export function Header({ selectedCount, onSelectAll, onOpenLinks, onSaveSession, onDeleteSession, onReviveSession, onMoveToActive, isHistorySession, isGraveyardSession }: HeaderProps) {
  ...
  if (isHistorySession) {
    return (
      <div className="h-[57px] min-w-[200px] relative shrink-0 w-full">
        <div className="box-border content-stretch flex gap-[12px] h-[57px] items-center min-w-inherit overflow-clip p-[12px] relative rounded-[inherit] w-full">
          <div className="basis-0 content-stretch flex grow items-center justify-between min-h-px min-w-px relative shrink-0">
